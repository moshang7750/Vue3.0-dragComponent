import { computed, createApp, defineComponent, getCurrentInstance, inject, onBeforeUnmount, onMounted, PropType, provide, reactive, ref, withCtx } from "vue";
...
export const DropdownOption = defineComponent({
    ...
    return ()=> (
        <div class="dropdown-service-option" onClick={handler.onClick} >
